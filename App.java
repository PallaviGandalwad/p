...
class App
{
	...
	static { System.loadLibrary("calc"); }//calc.so loading
...
class AppFrame extends JFrame
{
	...
	public AppFrame()
	{
		...
		graphicsCard.put("2GB",3000);
		
		graphicsCard.put("4GB",5000);

		graphicsCard.put("8GB",8000);
		...
		add(panel1);	add(panel2);	add(panel3);	add(panel4);	add(panel5);	add(panel6);	add(panel7);	add(panel8);	add(panel9);	add(panel10);
...
class MarvellousLogin extends JFrame implements ActionListener 
{
  ...
  {
	super ("Marvellous shoping Portal");
	setContentPane(new JLabel(new ImageIcon("/home/dell/Desktop/CompShoppiProj/colorful.jpg")));

	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	
	l1=new JLabel("Usrname");
	l1.setBounds(50,70,150,20);
	
	tf1=new JTextField();
	tf1.setBounds(50,100,200,20);
            tf1.setToolTipText("Enter your usernmae");
...
add(tf2);
	...
	public void CheckAuthentication()
	{
	  ...
	  else
	  {
		...
		if(Cnt == 0)
		{
		  JOptionPane.showMessageDialog(this,"Number of attempt finish .");
		  dispose();
		}
		else
		{
